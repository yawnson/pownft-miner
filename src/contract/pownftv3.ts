...
export const abi = [
  {
    inputs: [{ internalType: "address", name: "contract_v2", type: "address" }],
  ...
  },
  {
    inputs: [
      { internalType: "uint256", name: "_tokenId", type: "uint256" },
      { internalType: "uint256", name: "_withdrawEthUntil", type: "uint256" },
    ],
    name: "migrate",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint256[]", name: "_withdrawUntil", type: "uint256[]" },
    ],
...
export function powNftContract(signer: Signer) {
  return new Contract(MAINNET_ADDRESS, abi, signer);
}
